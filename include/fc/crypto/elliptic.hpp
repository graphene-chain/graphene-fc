...
namespace fc {
  ...
  namespace ecc {
    ...
    typedef fc::sha256                  blinded_hash;    //liruigang20180925 sync fc
    typedef fc::sha256                  blind_signature;       //liruigang20180925 sync fc
    ...
    class extended_public_key : public public_key
    {
        public:
            ...
            public_key generate_p( int i ) const;  //liruigang20180925 sync fc
            public_key generate_q( int i ) const;  //liruigang20180925 sync fc
        private:
            sha256 c;
